...
Em média, as mulheres que participaram do experimento tiveram uma associação implícita (medida pelo IAT) com a matemática **negativa** e **média** (média 0.570, desv. padrão 0.423, N = 65). Homens tiveram uma associação **negativa** com a matemática, portanto **menor** que a das mulheres (média 0.400 , desv. padrão 0.516, N = 48), ou seja, os homens tiveram uma associação maior à matemática do que a associação das mulheres. Houve portanto uma **pequena** diferença entre homens e mulheres (diferença das médias -0.170, 95% CI [-0.340, 0.001]). 

A partir desta amostra, estimamos que pode não haver uma diferença entre sexos, ou se ela existir, ela provavelmente teria força baixa para o lado negativo (-0.353) e extremamente pequena para o lado positivo (0.006). Sabendo que o intervalo inclui o 0, podemos reforçar que pode não haver uma diferença entre sexos.
